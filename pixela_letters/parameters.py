...
class Parameters(object):
    ...
    def _create_parser(default_user_name, default_token):
        ...
        parser.add_argument("-g", "--graph", required=True, help="set Pixela graph name that will be written letters.")
        parser.add_argument("poem", help="set poem that will be written to the graph.")
        return parser
